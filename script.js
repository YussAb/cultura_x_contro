...
const translations = {
  it: {
    ...
    manifesto_intro: "Questi sono alcuni dei valori da cui nasce Cultura X Contro: una traccia viva, non un regolamento chiuso. Verranno ridiscussi e ampliati nel tempo, insieme a chi sente la stessa direzione. Il progetto è apolitico, apartitico e areligioso: mette al centro le persone, la responsabilità e la comunità reale, contro le logiche istituzionali che spengono il pensiero, addomesticano la cultura e trasformano le relazioni in pubblico passivo. Se ti riconosci in questa posizione, iscriviti alla newsletter.",
    m1_title: "Cultura",
    ...
    about_p4: "È inoltre fondatore di Cultura Contro, un progetto nato dalla convinzione che, in un'epoca dominata da algoritmi, polarizzazione e consumo rapido dei contenuti, sia necessario andare controcorrente e restituire alla cultura il suo ruolo più autentico per stimolare il pensiero critico e generare nuove forme di incontro e dialogo.",
  ...
  en: {
    ...
    manifesto_title: "Manifesto",
    manifesto_intro: "These are some of the values Cultura X Contro was born from: a living outline, not a closed rulebook. They will be questioned, discussed, and expanded over time with those who feel the same direction. The project is apolitical, non-partisan, and areligious: it places people, responsibility, and real community at the center, against institutional logics that dull thought, domesticate culture, and turn relationships into a passive audience. If this position speaks to you, subscribe to the newsletter.",
    m1_title: "Culture",
