...
const translations = {
  it: {
    ...
    entry_rule_2: "Non sale a bordo chi pensa di essere sto cazzo.",
    entry_rule_3: "La parola data resta parola: se prometti, mantieni.",
    entry_rule_4: "Una ciurma è forte quando ogni membro sceglie di diventare più forte anche per gli altri.",
  ...
  en: {
    ...
    entry_rules_kicker: "To be sure we agreed on some points",
    entry_rules_title: "You should agree to these basic rules",
    entry_rule_1: "No one boards if they take themselves too seriously: here we work, fail, laugh, and learn.",
    entry_rule_2: "No one boards if they think they are the whole show.",
    entry_rule_3: "Your word stays your word: if you commit, you keep it.",
    entry_rule_4: "A crew is strong when every member chooses to become stronger for the others too.",
